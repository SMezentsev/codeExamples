...
class Report3 extends \app\modules\itrack\models\Extdata
{
    
    const  TYPEOF = 'reportRafarma3';
    public $series;
    public $grpcode;
    public $weight;
    public $fio;
    ...
    {
        return [
            'default' => ['series', 'grpcode', 'weight', 'fio', 'boxNumber', 'typeof', 'boxNumberOk', 'companyPrefix', 'dateOfCreation', 'dateOfExpiration', 'orderId', 'comment'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        if (!empty($params["boxNumberOk"])) {
            $query->andFilterWhere(['data5' => $params["boxNumberOk"]]);
        }
    ...
    public function init()
    {
        ...
        $this->on(self::EVENT_BEFORE_INSERT, function ($event) {
            ...
            $data[] = $event->sender->data5 = $event->sender->boxNumberOk ?? '';
