...
class Rafarma3Controller extends \app\modules\itrack\controllers\ExtdataController
{
    
    use ControllerTrait;
    
    public $modelClass = 'app\modules\itrack\models\rafarma\Report3';
    public $serializer = [
        'class'              => 'app\modules\itrack\components\boxy\Serializer',
        'collectionEnvelope' => 'box-data',
    ];
    ...
    public function prepareDataProvider()
    {
        ...
        \app\modules\itrack\models\AuditLog::Audit(\app\modules\itrack\models\AuditOperation::OP_REPORT, 'Запрос данных box-data', []);
    ...
    public function actionMulti()
    {
        ...
        $mc = $this->modelClass;
        \app\modules\itrack\models\AuditLog::Audit(\app\modules\itrack\models\AuditOperation::OP_REPORT_DATA, 'Добавление данных в box-data', [["field" => "Массив значений", "value" => $data]]);
