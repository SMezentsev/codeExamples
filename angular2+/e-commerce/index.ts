...
export { ManufacturersDataSource } from '../reference/_data-sources/manufacturers.datasource';
...
export {
    ...
    selectHasManufacturersInStore,
    selectManufacturersActionLoading,
    selectManufacturersInitWaitingMessage
} from '../reference/_selectors/manufacturer.selectors';
